...
const expenseTwo = store.dispatch(addExpense({ description: 'Coke', amount: 100, createdAt: 100 }))
const expenseThree = store.dispatch(addExpense({ description: 'Food', amount: 500, createdAt: 400 }))
